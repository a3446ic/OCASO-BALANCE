CREATE OR REPLACE PROCEDURE EXT.SP_REPARTE_PAGOS_DIRECTOS_OPTIMIZADO(IN i_tipo_reparto VARCHAR(10), IN i_PERIODSEQ BIGINT, IN i_proc_name_principal VARCHAR(50), IN v_idproceso INT, IN v_num_POST INT, INOUT v_log_count INTEGER)
LANGUAGE SQLSCRIPT  
...
BEGIN
    ...
    DECLARE TEMP_PAGOS_DIRECTOS TABLE (
    	CAMPO1 INT
    );
    
    
    ---------101_01_RT
    DECLARE TEMP_PAGOS_DIRECTOS_101_01_RT TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_101_01_RT TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
	    LINENUMBER        BIGINT,
	    SUBLINENUMBER     BIGINT,
	    EVENTTYPEID       VARCHAR(5),
	    PRODUCTID         VARCHAR(50),
	    CODIGO_POLIZA     VARCHAR(50),
	    COMPENSATIONDATE  DATE,
	    ESTADO            VARCHAR(10),
	    POLIZA_FISICA     VARCHAR(50),
	    POLIZA_CORREGIDA  VARCHAR(50),
	    PRIMA_CORREGIDA   DECIMAL(15,2),
	    PRIMA_NETA        DECIMAL(15,2),
	    PRIMA_NETA_ANUAL  DECIMAL(15,2),
	    PRIMA_COMIS_S4    DECIMAL(15,2),
	    COD_AGENTE        VARCHAR(50)
	);

    
   DECLARE TEMP_FINAL_PAGOS_BASES_101_01_RT TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
	    ...
	    TIPO_AGENTE         DECIMAL(5,2),
	    IMPORTE             DECIMAL(15,2),
	    SUMA_IMPORTE        DECIMAL(15,2),
	    TIPO_REPARTO        VARCHAR(255),
	    NUM_TRAMO           INTEGER,
	    REPARTO_TIPO_BASE   VARCHAR(10),
	    REPARTO_PORCENTAJE  DECIMAL(15,2),
	    POLIZA_FISICA       VARCHAR(50),
	    POLIZA_CORREGIDA    VARCHAR(50),
	    PRIMA_CORREGIDA     DECIMAL(15,2),
	    PRIMA_NETA          DECIMAL(15,2),
	    PRIMA_NETA_ANUAL    DECIMAL(15,2),
	    PRIMA_COMIS         DECIMAL(15,2),
	    COEF_TIPO_BASE      VARCHAR(10),
	    COEF_CORRECTOR      DECIMAL(15,2),
	    COD_AGENTE          VARCHAR(50),
	    TIPO_LIQ            VARCHAR(50)
	);

    
    DECLARE TEMP_PAGOS_DIRECTOS_101_01_RT_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    	DEPOSITO         VARCHAR(255),
    	SUMA_PAGOS       DECIMAL(15,2)
    );
    
    DECLARE TEMP_FINAL_PAGOS_BASES_101_01_RT_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------101_01_RG
    DECLARE TEMP_PAGOS_DIRECTOS_101_01_RG TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_101_01_RG TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_101_01_RG TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_101_01_RG_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_101_01_RG_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------101_03_RT
    DECLARE TEMP_PAGOS_DIRECTOS_101_03_RT TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_101_03_RT TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_101_03_RT TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_101_03_RT_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_101_03_RT_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------101_01_RG
    DECLARE TEMP_PAGOS_DIRECTOS_101_03_RG TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_101_03_RG TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_101_03_RG TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_101_03_RG_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_101_03_RG_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------102_01_RT
    DECLARE TEMP_PAGOS_DIRECTOS_102_01_RT TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_102_01_RT TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_102_01_RT TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_102_01_RT_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_102_01_RT_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------102_01_RG
    DECLARE TEMP_PAGOS_DIRECTOS_102_01_RG TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_102_01_RG TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_102_01_RG TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_102_01_RG_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_102_01_RG_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------102_03_RT
    DECLARE TEMP_PAGOS_DIRECTOS_102_03_RT TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_102_03_RT TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_102_03_RT TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_102_03_RT_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_102_03_RT_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------102_03_RG
    DECLARE TEMP_PAGOS_DIRECTOS_102_03_RG TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_102_03_RG TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_102_03_RG TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_102_03_RG_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_102_03_RG_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------112_01_RT
    DECLARE TEMP_PAGOS_DIRECTOS_112_01_RT TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_112_01_RT TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_112_01_RT TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_112_01_RT_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_112_01_RT_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------112_01_RG
    DECLARE TEMP_PAGOS_DIRECTOS_112_01_RG TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_112_01_RG TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_112_01_RG TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_112_01_RG_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_112_01_RG_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------112_03_RT
    DECLARE TEMP_PAGOS_DIRECTOS_112_03_RT TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_112_03_RT TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_112_03_RT TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_112_03_RT_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_112_03_RT_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	---------112_03_RG
    DECLARE TEMP_PAGOS_DIRECTOS_112_03_RG TABLE (
    	PARTICIPANTSEQ   BIGINT,
    	POSITIONSEQ      BIGINT,
    	PERIODSEQ        BIGINT,
    	POS_CALLIDUS     VARCHAR(255),
    ...
    DECLARE TEMP_BASES_112_03_RG TABLE (
	    POSITIONSEQ       BIGINT,
	    AUTOLIQUIDA       SMALLINT,
	    IMPORTE_COMISION  DECIMAL(15,2),
	    ORDERID           BIGINT,
   ...
   DECLARE TEMP_FINAL_PAGOS_BASES_112_03_RG TABLE (
		PARTICIPANTSEQ      BIGINT,
	    POSITIONSEQ         BIGINT,
	    PERIODSEQ           BIGINT,
	    PERIODO             VARCHAR(20),
    ...
    DECLARE TEMP_PAGOS_DIRECTOS_112_03_RG_LC TABLE (
		PERIODSEQ        BIGINT,
    	POS_PRIN         VARCHAR(255),
    	EARNINGGROUPID   VARCHAR(255),
    	EARNINGCODEID    VARCHAR(255),
    ...
    DECLARE TEMP_FINAL_PAGOS_BASES_112_03_RG_DIF TABLE (
	    PERIODSEQ        BIGINT,
	    POS_PRIN         VARCHAR(255),
	    TIPO_DOCUMENTO   VARCHAR(1),
	    DEPOSITSEQ       BIGINT,
	...
	DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN ROLLBACK;
        CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log,v_proc_name,v_proc_name_secundario || ' Error en procedimiento principal ' || v_proc_name_secundario || ' - SQL_ERROR_MESSAGE: ' || IFNULL(::SQL_ERROR_MESSAGE, '') || '. SQL_ERROR_CODE: ' || ::SQL_ERROR_CODE,v_log_count,v_idproceso,'error');
    ...
    CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, v_proc_name, '--------------'||v_proc_name_secundario || '---'||i_tipo_reparto||'-------------------' , v_log_count, v_idproceso, 'info');
	...
	INSERT INTO :TEMP_REPEXT_PAGOS_REPARTO_FILE(PARTICIPANTSEQ, POSITIONSEQ, PERIODSEQ, POS_CALLIDUS, POS_PRIN, MANAGER_POS_PRIN, FECHA_CARGO, TIPO_AGENTE, NIF, PROGRAMA
                ...
                --SMM AND P.NIF = '27313680F'
                ;
                
            v_num_rows = RECORD_COUNT(:TEMP_REPEXT_PAGOS_REPARTO_FILE);
            
            SELECT ':TEMP_REPEXT_PAGOS_REPARTO_FILE',* FROM :TEMP_REPEXT_PAGOS_REPARTO_FILE;
                
            CALL LIB_GLOBAL:WRITE_LOG(v_permisos_log,v_proc_name,'Fin Carga de la tabla TEMP_REPEXT_PAGOS_REPARTO_FILE: '|| v_num_rows || ' filas.', v_log_count, v_idproceso, 'info');
...
-- 		---------------------------------------------------------------------------------------------------
		...
		-- PAGOS 
		TEMP_PAGOS_DIRECTOS_101_01_RT =
		SELECT 
		    P.*,
		    CASE WHEN RIGHT(P.EARNINGGROUPID,3) = 'AUT' THEN 1 ELSE 0 END AS ES_AUT
		FROM :TEMP_PAGOS_DIRECTOS P
		WHERE SUBSTRING(P.EARNINGGROUPID,7,5) = '01-RT'
		  AND P.EARNINGCODEID = '101';
		...
		IF i_tipo_reparto = 'CIERRE' THEN
		    ...
		    SELECT 
		        ...
		        PRIMA_COMIS_S4,
		        COD_AGENTE
		    FROM EXT.FINAL_BASES_REPARTO_POLIZA_FILE_TEST B
		    WHERE B.PERIODSEQ = i_periodSeq
		      AND B.PRODUCTID LIKE '012%'
		      AND (
		            B.EVENTTYPEID IN ('71','65','66','72','42')
		            OR (
		                B.EVENTTYPEID = '43'
		                AND EXISTS (
		                    SELECT 1
		                    FROM EXT.TEMP_REPEXT_TXN_FILE_TEST T
		...
		ELSE
		    ...
		    WHERE B.PERIODSEQ = v_periodSeqAnterior
		      AND B.PRODUCTID LIKE '012%'
		      AND (
		            B.EVENTTYPEID IN ('71','65','66','72','42')
		            OR (
		...
		-- PRE-AGREGACIÓN 
		TEMP_SUMAS_101_01_RT =
		SELECT 
		    POSITIONSEQ,
		    SUM(CASE WHEN AUTOLIQUIDA = 1 THEN IMPORTE_COMISION ELSE 0 END) AS SUMA_AUT,
		    SUM(CASE WHEN IFNULL(AUTOLIQUIDA,0) = 0 THEN IMPORTE_COMISION ELSE 0 END) AS SUMA_NO_AUT
		FROM :TEMP_BASES_101_01_RT
		WHERE IMPORTE_COMISION <> 0
		GROUP BY POSITIONSEQ;

		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, v_proc_name,'TEMP_SUMAS_101_01_RT ' || ::ROWCOUNT, v_log_count, v_idproceso, 'info');
		
		-- RESULTADO FINAL 
		TEMP_FINAL_PAGOS_BASES_101_01_RT =
		...
		SELECT 
		    ...
		    P.POS_CALLIDUS AS POSITIONNAME,
		    P.POS_PRIN,
		    P.NIF,
		    P.MANAGER_POS_PRIN,
		    ...
		    CASE 
		        WHEN P.ES_AUT = 1 THEN S.SUMA_AUT
		        ELSE S.SUMA_NO_AUT
		    END AS SUMA_IMPORTE,
		    ...
		    B.PRIMA_NETA,
		    B.PRIMA_NETA_ANUAL,
		    B.PRIMA_COMIS_S4 AS PRIMA_COMIS,
		...
		INNER JOIN :TEMP_BASES_101_01_RT B 
		    ON P.POSITIONSEQ = B.POSITIONSEQ
		   AND B.IMPORTE_COMISION <> 0
		
		INNER JOIN :TEMP_SUMAS_101_01_RT S
		    ON B.POSITIONSEQ = S.POSITIONSEQ
		
		-- reemplazo de NOT EXISTS
		LEFT JOIN EXT.FINAL_REPEXT_FILE_TEST X 
		    ON X.POS_PRIN       = P.POS_PRIN
		...
		WHERE 
		    X.POS_PRIN IS NULL
		    AND (
		        (P.ES_AUT = 1 AND B.AUTOLIQUIDA = 1)
		        OR
		        (P.ES_AUT = 0 AND IFNULL(B.AUTOLIQUIDA,0) = 0)
		    );
  ...
  --  			        SELECT T.SALESTRANSACTIONSEQ FROM EXT.TEMP_REPEXT_TXN_FILE_TEST T
  --  			        WHERE T.SALESTRANSACTIONSEQ = B.SALESTRANSACTIONSEQ
  --  			        AND T.FECHA_EFECTO > ADD_MONTHS(T.FECHA_VTO_RECIBO,-12)
  --  			    )))
  --  			;
...
--                                 ) AS SUMA_IMPORTE,
	...
	--		AND F.EARNINGCODEID = T.EARNINGCODEID AND F.EARNINGGROUPID = T.EARNINGGROUPID
		...
		--BASES
		IF i_tipo_reparto = 'CIERRE' THEN
			TEMP_BASES_101_01_RG = SELECT POSITIONSEQ,AUTOLIQUIDA,IMPORTE_COMISION,ORDERID,LINENUMBER,SUBLINENUMBER,EVENTTYPEID,PRODUCTID,CODIGO_POLIZA,COMPENSATIONDATE,ESTADO,POLIZA_FISICA
				,POLIZA_CORREGIDA,PRIMA_CORREGIDA,PRIMA_NETA,PRIMA_NETA_ANUAL,PRIMA_COMIS_S4,COD_AGENTE 
				FROM EXT.FINAL_BASES_REPARTO_POLIZA_FILE_TEST B
    			WHERE PERIODSEQ = i_periodSeq
    	...
    	ELSE
    		TEMP_BASES_101_01_RG = SELECT POSITIONSEQ,
		        AUTOLIQUIDA,IMPORTE_COMISION,ORDERID,LINENUMBER,SUBLINENUMBER,EVENTTYPEID,PRODUCTID,CODIGO_POLIZA,COMPENSATIONDATE
		        	,ESTADO,POLIZA_FISICA,POLIZA_CORREGIDA,PRIMA_CORREGIDAPRIMA_NETA,PRIMA_NETA_ANUAL,PRIMA_COMIS_S4,COD_AGENTE     			
		        FROM EXT.FINAL_BASES_REPARTO_POLIZA_FILE_NUEVA_BASE_REPARTO B
    			WHERE PERIODSEQ = v_periodSeqAnterior
    			-- EARNINGGROUPID = '01-RG'
    			AND PRODUCTID LIKE '01%' AND PRODUCTID NOT LIKE '012%'
    	...
    	TEMP_FINAL_PAGOS_BASES_101_01_RG = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_101_01_RG B ON P.POSITIONSEQ = B.POSITIONSEQ AND B.IMPORTE_COMISION <> 0
    					INNER JOIN :TEMP_SUMAS_101_01_RG S
		    				ON B.POSITIONSEQ = S.POSITIONSEQ
		    			LEFT JOIN EXT.FINAL_REPEXT_FILE_TEST X 
							 ON X.POS_PRIN       = P.POS_PRIN
							AND X.PERIODSEQ      = P.PERIODSEQ
   ...
   -- 	BASES_TOTAL_IMPORTE_101_03_RT = 
    	...
    	TEMP_FINAL_PAGOS_BASES_101_03_RT = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_101_03_RT B ON P.POSITIONSEQ = B.POSITIONSEQ AND B.IMPORTE_COMISION <> 0
    					INNER JOIN :TEMP_SUMAS_101_03_RT S
		    				ON B.POSITIONSEQ = S.POSITIONSEQ
		    			-- reemplazo de NOT EXISTS
						LEFT JOIN EXT.FINAL_REPEXT_FILE_TEST X 
						   ON X.POS_PRIN       = P.POS_PRIN
   ...
   -- PRE-AGREGACIÓN 
    	...
    	TEMP_FINAL_PAGOS_BASES_101_03_RG = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_101_03_RG B ON P.POSITIONSEQ = B.POSITIONSEQ AND B.IMPORTE_COMISION <> 0
    					INNER JOIN :TEMP_SUMAS_101_03_RG S
						    ON B.POSITIONSEQ = S.POSITIONSEQ
						-- reemplazo de NOT EXISTS
						LEFT JOIN EXT.FINAL_REPEXT_FILE_TEST X 
						    ON X.POS_PRIN       = P.POS_PRIN
	...
	---------------------------------------------------------------------------------------------------
    	...
    	CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, v_proc_name,'SMM-1 ' || ::ROWCOUNT, v_log_count, v_idproceso, 'info');
    
    -- PRE-AGREGACIÓN 
		TEMP_SUMAS_102_01_RT =
		SELECT 
		    POSITIONSEQ,
		    SUM(CASE WHEN AUTOLIQUIDA = 1 THEN IMPORTE_COMISION ELSE 0 END) AS SUMA_AUT,
		    SUM(CASE WHEN IFNULL(AUTOLIQUIDA,0) = 0 THEN IMPORTE_COMISION ELSE 0 END) AS SUMA_NO_AUT
    	...
    	--FINAL
	    TEMP_FINAL_PAGOS_BASES_102_01_RT =
			SELECT 
			    P.PARTICIPANTSEQ,
			    P.POSITIONSEQ,
			    P.PERIODSEQ,
		...
		INNER JOIN :TEMP_BASES_102_01_RT B 
		    ON P.POSITIONSEQ = B.POSITIONSEQ
		   AND B.IMPORTE_COMISION <> 0
		
		INNER JOIN :TEMP_SUMAS_102_01_RT S
		    ON B.POSITIONSEQ = S.POSITIONSEQ
     ...
     --                           P.TIPO_LIQ
	    ...
	    --     				(RIGHT(P.EARNINGGROUPID,3) <> 'AUT' AND IFNULL(B.AUTOLIQUIDA,0) = 0)
    	-- 				);
    					CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, v_proc_name,'SMM-2 ' || ::ROWCOUNT, v_log_count, v_idproceso, 'info');
   ...
   -- PRE-AGREGACIÓN 
    	...
    	TEMP_FINAL_PAGOS_BASES_102_01_RG = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_102_01_RG B ON P.POSITIONSEQ = B.POSITIONSEQ  AND B.IMPORTE_COMISION <> 0
    					INNER JOIN :TEMP_SUMAS_101_01_RT S
						    ON B.POSITIONSEQ = S.POSITIONSEQ
    ...
    -- PRE-AGREGACIÓN 
    	...
    	TEMP_FINAL_PAGOS_BASES_102_03_RT = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_102_03_RT B ON P.POSITIONSEQ = B.POSITIONSEQ AND B.IMPORTE_COMISION <> 0
    					INNER JOIN :TEMP_SUMAS_102_03_RT S
							 ON B.POSITIONSEQ = S.POSITIONSEQ
    ...
    -- PRE-AGREGACIÓN 
    	...
    	TEMP_FINAL_PAGOS_BASES_102_03_RG = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_102_03_RG B ON P.POSITIONSEQ = B.POSITIONSEQ AND B.IMPORTE_COMISION <> 0
    					INNER JOIN :TEMP_SUMAS_102_03_RG S
		    				ON B.POSITIONSEQ = S.POSITIONSEQ
    					-- reemplazo de NOT EXISTS
						LEFT JOIN EXT.FINAL_REPEXT_FILE_TEST X 
						    ON X.POS_PRIN       = P.POS_PRIN
   ...
   -- PRE-AGREGACIÓN 
    	...
    	TEMP_FINAL_PAGOS_BASES_112_01_RT = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_112_01_RT B ON P.POSITIONSEQ = B.POSITIONSEQAND B.IMPORTE_COMISION <> 0
		
						INNER JOIN :TEMP_SUMAS_112_01_RT S
		    				ON B.POSITIONSEQ = S.POSITIONSEQ
   ...
   -- PRE-AGREGACIÓN 
    	...
    	TEMP_FINAL_PAGOS_BASES_112_01_RG = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_112_01_RG B ON P.POSITIONSEQ = B.POSITIONSEQAND B.IMPORTE_COMISION <> 0
		
						INNER JOIN :TEMP_SUMAS_112_01_RG S
						    ON B.POSITIONSEQ = S.POSITIONSEQ
   ...
   -- PRE-AGREGACIÓN 
    	...
    	TEMP_FINAL_PAGOS_BASES_112_03_RT = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_112_03_RT B ON P.POSITIONSEQ = B.POSITIONSEQ AND B.IMPORTE_COMISION <> 0
    				--	INNER JOIN :BASES_TOTAL_IMPORTE_112_03_RT BT ON BT.POSITIONSEQ = B.POSITIONSEQ
    					INNER JOIN :TEMP_SUMAS_112_03_RT S
						    ON B.POSITIONSEQ = S.POSITIONSEQ
   ...
   -- PRE-AGREGACIÓN 
    	...
    	TEMP_FINAL_PAGOS_BASES_112_03_RG = SELECT P.PARTICIPANTSEQ,
    					...
    					INNER JOIN :TEMP_BASES_112_03_RG B ON P.POSITIONSEQ = B.POSITIONSEQ AND B.IMPORTE_COMISION <> 0
    					--INNER JOIN :BASES_TOTAL_IMPORTE_112_03_RG BT ON BT.POSITIONSEQ = B.POSITIONSEQ
    					INNER JOIN :TEMP_SUMAS_112_03_RG S
		    				ON B.POSITIONSEQ = S.POSITIONSEQ
    					-- reemplazo de NOT EXISTS
						LEFT JOIN EXT.FINAL_REPEXT_FILE_TEST X 
						    ON X.POS_PRIN       = P.POS_PRIN
...
----------------------------------------------------------------
		...
		IF i_tipo_reparto = 'CIERRE' THEN
			TEMP_BASES_123_126_127_01_RT = SELECT * 
	    		...
	    		AND PRODUCTID LIKE '012%' --- IBM 20260604 Añadimos el producto para filtrar mas
	    		AND EVENTTYPEID = '11';
	...
	--		AND F.EARNINGCODEID = T.EARNINGCODEID AND F.EARNINGGROUPID = T.EARNINGGROUPID
		...
		IF i_tipo_reparto = 'CIERRE' THEN
			TEMP_BASES_123_126_127_01_RG = SELECT * 
	    		...
	    		-- AND PRODUCTID LIKE '01%' AND PRODUCTID NOT LIKE '012%'
	    		-- EARNINGCODEID = '123_126_127'
	    		AND PRODUCTID LIKE '01%' AND PRODUCTID NOT LIKE '012%'  --- IBM 20260604 Añadimos el producto para filtrar mas
	    		AND EVENTTYPEID = '11';
	...
	--		AND F.EARNINGCODEID = T.EARNINGCODEID AND F.EARNINGGROUPID = T.EARNINGGROUPID
		...
		IF i_tipo_reparto = 'CIERRE' THEN
			TEMP_BASES_123_126_127_03_RT = SELECT * 
	    		...
	    		WHERE PERIODSEQ = i_periodSeq
	    		-- EARNINGGROUPID = '01-RT'
	    		AND PRODUCTID LIKE '032%' --- IBM 20260604 Añadimos el producto para filtrar mas
	    		-- EARNINGCODEID = '123_126_127'
	    		AND EVENTTYPEID = '11';
	...
	--		AND F.EARNINGCODEID = T.EARNINGCODEID AND F.EARNINGGROUPID = T.EARNINGGROUPID
		...
		IF i_tipo_reparto = 'CIERRE' THEN
			TEMP_BASES_123_126_127_03_RG = SELECT * 
	    		...
	    		-- AND PRODUCTID LIKE '03%' AND PRODUCTID NOT LIKE '032%'
	    		-- EARNINGCODEID = '123_126_127'
	    		AND PRODUCTID LIKE '03%' AND PRODUCTID NOT LIKE '032%'  --- IBM 20260604 Añadimos el producto para filtrar mas
	    		AND EVENTTYPEID = '11';
 ...
 -------------------------------------------------------------------------------------------------------
		...
		IF i_tipo_reparto = 'CIERRE' THEN
			TEMP_BASES_124_125_01_RT = SELECT * 
	    		FROM EXT.FINAL_BASES_REPARTO_POLIZA_FILE_TEST B
	    		WHERE PERIODSEQ = i_periodSeq
	    		AND PRODUCTID LIKE '012%' --- IBM 20260604 Añadimos el producto para filtrar mas-- EARNINGGROUPID = '01-RT'
	    		-- EARNINGGROUPID = '01-RT'
...
DO BEGIN
	DECLARE V_PERIODSEQ BIGINT = 2533274790398829;
	DECLARE V_LOG_COUNT INT = 1;
...
--  --   TRUNCATE TABLE EXT.FINAL_REPEXT_PAGOS_FILE_TEST;
    ...
    SELECT * FROM EXT.FINAL_REPEXT_PAGOS_FILE WHERE PERIODSEQ IN (2533274790398829,2533274790398828)
    -- AND POS_CALLIDUS = '04606715E0000'
    -- AND DEPOSITSEQ = 18858824107547168
    ;
	DELETE FROM EXT.FINAL_REPEXT_FILE_TEST WHERE PERIODSEQ IN (2533274790398829,2533274790398828);
	DELETE FROM EXT.FINAL_REPEXT_PAGOS_FILE_TEST WHERE PERIODSEQ IN (2533274790398829,2533274790398828);
	
	INSERT INTO EXT.FINAL_REPEXT_PAGOS_FILE_TEST
		SELECT * FROM EXT.FINAL_REPEXT_PAGOS_FILE_BKP
		WHERE PERIODSEQ IN (2533274790398829,2533274790398828);
   
    UPDATE EXT.FINAL_REPEXT_PAGOS_FILE_TEST SET ESTADO_REPARTO = 1 WHERE PERIODSEQ = 2533274790398829;
    UPDATE EXT.FINAL_REPEXT_PAGOS_FILE_TEST SET TIPO_LIQ = 'BALANCE' WHERE PERIODSEQ = 2533274790398829 AND TIPO_LIQ = '';
    
    SELECT 'INICIO',* FROM EXT.FINAL_REPEXT_PAGOS_FILE_TEST;
    
	DELETE FROM EXT.CSE_LOG WHERE OBJECT LIKE '%SP_REPARTE_PAGOS_DIRECTOS%' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
	
	CALL EXT.SP_REPARTE_PAGOS_DIRECTOS('BALANCE', v_PeriodSeq, 'SP_REPARTE_PAGOS_DIRECTOS',0,0,V_LOG_COUNT);
	
	 SELECT 'INICIO',* FROM EXT.CSE_LOG WHERE OBJECT LIKE '%SP_REPARTE_PAGOS_DIRECTOS%' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
END;
...
-- 	SELECT STARTDATE INTO v_PeriodStartDateCierre FROM CS_PERIOD WHERE PERIODSEQ = i_PERIODSEQ_FEB;
    	
--     	SELECT PERIODSEQ INTO v_periodSeqAnterior
-- 		FROM CS_PERIOD PER
-- 		INNER JOIN TCMP.CS_CALENDAR CAL ON CAL.CALENDARSEQ = PER.CALENDARSEQ
-- 			AND CAL.REMOVEDATE = v_eot
-- 			AND UPPER(CAL.NAME) = 'MAIN MONTHLY CALENDAR'
...
--  --   TRUNCATE TABLE EXT.FINAL_REPEXT_PAGOS_FILE_TEST;
--  --   INSERT INTO EXT.FINAL_REPEXT_PAGOS_FILE_TEST
--  --   SELECT * FROM EXT.FINAL_REPEXT_PAGOS_FILE_TEST WHERE PERIODSEQ IN (i_PERIODSEQ_FEB,v_periodSeqAnterior)
--  --   -- AND POS_CALLIDUS = '04606715E0000'
--  --   -- AND DEPOSITSEQ = 18858824107547168
--  --   ;
-- 	DELETE FROM EXT.FINAL_REPEXT_FILE_TEST WHERE PERIODSEQ IN (i_PERIODSEQ_FEB,v_periodSeqAnterior);
-- 	DELETE FROM EXT.FINAL_REPEXT_PAGOS_FILE_TEST WHERE PERIODSEQ IN (i_PERIODSEQ_FEB,v_periodSeqAnterior);
	
-- 	INSERT INTO EXT.FINAL_REPEXT_PAGOS_FILE_TEST
-- 		SELECT * FROM EXT.FINAL_REPEXT_PAGOS_FILE_BKP
-- 		WHERE PERIODSEQ IN (i_PERIODSEQ_FEB,v_periodSeqAnterior);
   
--     UPDATE EXT.FINAL_REPEXT_PAGOS_FILE_TEST SET ESTADO_REPARTO = 1 WHERE PERIODSEQ = i_PERIODSEQ_FEB;
--     UPDATE EXT.FINAL_REPEXT_PAGOS_FILE_TEST SET TIPO_LIQ = 'BALANCE' WHERE PERIODSEQ = i_PERIODSEQ_FEB AND TIPO_LIQ = '';
    
--     SELECT 'INICIO',* FROM EXT.FINAL_REPEXT_PAGOS_FILE_TEST;
    
-- 	DELETE FROM EXT.CSE_LOG WHERE OBJECT LIKE 'EXT.SP_REPEXT_NUEVA_BASE_REPARTO' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
	
-- 	CALL EXT.SP_REPARTE_PAGOS_DIRECTOS('CIERRE', i_PERIODSEQ_FEB, 'EXT.SP_REPEXT_NUEVA_BASE_REPARTO',1,0,v_log_count);
-- 	CALL EXT.SP_REPARTE_PAGOS_DIRECTOS('BALANCE', i_PERIODSEQ_FEB, 'EXT.SP_REPEXT_NUEVA_BASE_REPARTO',1,0,v_log_count);
	
-- 	SELECT  * FROM EXT.CSE_LOG WHERE OBJECT LIKE 'EXT.SP_REPEXT_NUEVA_BASE_REPARTO' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
	
-- 	SELECT 'FINAL_REPEXT_PAGOS_FILE_TEST',* FROM EXT.FINAL_REPEXT_PAGOS_FILE_TEST WHERE PERIODSEQ = 2533274790398826 AND POSITIONSEQ = 4785074604176708;
	
-- 	SELECT 'FINAL_REPEXT_PAGOS_FILE_TEST',* FROM EXT.FINAL_REPEXT_PAGOS_FILE_TEST WHERE PERIODSEQ = 2533274790398827 AND POSITIONSEQ = 4785074604176708;
-- 	-- SELECT 'FINAL_REPEXT_PAGOS_FILE_TEST',* FROM EXT.FINAL_REPEXT_PAGOS_FILE_TEST WHERE PERIODSEQ = 2533274790398827 AND POSITIONSEQ = 4785074604176708;
	
-- 	SELECT 'FINAL_REPEXT_FILE_TEST',* FROM EXT.FINAL_REPEXT_FILE_TEST WHERE PERIODSEQ = 2533274790398827 AND POSITIONSEQ = 4785074604176708 
-- 	AND EARNINGCODEID = 113
