CREATE OR REPLACE PROCEDURE EXT.SP_CARGA_BASES_REPARTO(IN i_par_tipo_ejecucion INTEGER, IN i_tipo_reparto VARCHAR(10), IN i_periodseq BIGINT 
	, IN i_fecha_reparto DATE, IN i_proc_name_principal VARCHAR(50) ,IN v_idproceso INTEGER, INOUT v_log_count INTEGER)
LANGUAGE SQLSCRIPT  
...
-- DO BEGIN
-- 	-- DECLARE i_periodSeq BIGINT = 2533274790398826;
-- 	DECLARE i_PERIODSEQ BIGINT = 2533274790398826; -- ENERO 2026
-- 	DECLARE i_PERIODSEQ_FEB BIGINT = 2533274790398827; -- FEBRERO 2026
-- 	DECLARE v_log_count INT = 0;
	
-- 	DELETE FROM EXT.CSE_LOG WHERE OBJECT LIKE 'EXT.SP_REPEXT_NUEVA_BASE_REPARTO' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
	
-- 	CALL EXT.SP_CARGA_BASES_REPARTO(1,'BALANCE', i_PERIODSEQ_FEB, '2200-01-01','EXT.SP_REPEXT_NUEVA_BASE_REPARTO',0,v_log_count);
	
-- 	SELECT  * FROM EXT.CSE_LOG WHERE OBJECT LIKE 'EXT.SP_REPEXT_NUEVA_BASE_REPARTO' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
	
-- 	SELECT * FROM EXT.FINAL_BASES_REPARTO_POLIZA_FILE_NUEVA_BASE_REPARTO WHERE POS_PRIN = '0020000452'
-- 	AND EVENTTYPEID = 16
...
-- DO BEGIN
-- 	-- DECLARE i_periodSeq BIGINT = 2533274790398826;
-- 	DECLARE i_PERIODSEQ_MRZ BIGINT = 2533274790398828; -- MARZO 2026
-- 	DECLARE i_PERIODSEQ_ABR BIGINT = 2533274790398829; -- ABRIL 2026
-- 	DECLARE v_log_count INT = 0;
	
-- 	DELETE FROM EXT.CSE_LOG WHERE OBJECT LIKE 'EXT.SP_REPEXT_NUEVA_BASE_REPARTO' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
	
-- 	CALL EXT.SP_CARGA_BASES_REPARTO(1,'BALANCE', i_PERIODSEQ_ABR
-- 	, '2200-01-01'
-- 	,'EXT.SP_REPEXT_NUEVA_BASE_REPARTO',0,v_log_count);
	
-- 	SELECT  * FROM EXT.CSE_LOG WHERE OBJECT LIKE 'EXT.SP_REPEXT_NUEVA_BASE_REPARTO' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
	
-- 	SELECT * FROM EXT.FINAL_BASES_REPARTO_POLIZA_FILE_NUEVA_BASE_REPARTO WHERE POS_PRIN = '0221009349'
-- 	-- AND EVENTTYPEID = 16
-- 	-- AND PRODUCTID LIKE '01%' AND PRODUCTID NOT LIKE '012%'
-- 	;
	
	
-- 	SELECT TOP 1 * FROM CS_POSITION WHERE NAME = 'B851161010000';
