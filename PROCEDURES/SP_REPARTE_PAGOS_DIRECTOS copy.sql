...
DO BEGIN
    ...
    TRUNCATE TABLE EXT.FINAL_REPEXT_PAGOS_FILE_TEST;
    INSERT INTO EXT.FINAL_REPEXT_PAGOS_FILE_TEST
    SELECT * FROM EXT.FINAL_REPEXT_PAGOS_FILE WHERE PERIODSEQ IN (i_PERIODSEQ_FEB,v_periodSeqAnterior)
    -- AND POS_CALLIDUS = '04606715E0000'
    -- AND DEPOSITSEQ = 18858824107547168
    ;
	...
	SELECT 'FINAL_REPEXT_PAGOS_FILE',* FROM EXT.FINAL_REPEXT_PAGOS_FILE WHERE PERIODSEQ = 2533274790398827 AND POSITIONSEQ = 4785074604176708;
	...
	SELECT 'FINAL_REPEXT_FILE',* FROM EXT.FINAL_REPEXT_FILE WHERE PERIODSEQ = 2533274790398827 AND POSITIONSEQ = 4785074604176708 
	AND EARNINGCODEID = 113
